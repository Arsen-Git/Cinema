...
var _roomJs = require("./components/room.js");
...
const newRoom = new (0, _roomJsDefault.default)(size, movie);
newRoom.render();
...
submitSeatsBtn.addEventListener("click", ()=>{
    ...
    if (confirmation) {
        ...
        (0, _timerJs.timerToReject)();
        newRoom.rejectSeats();
    }
});

},{"./components/room.js":"ax9cV","./components/timer.js":"6OOFy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ax9cV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _utils = require("../utils");
var _chair = require("./chair");
var _chairDefault = parcelHelpers.interopDefault(_chair);
function Room(size, movie) {
    this.size = size;
    this.movie = movie;
    this.elements = {};
    this.render = ()=>{
        ...
        this.allSeats = [];
        this.selectedSeats = (0, _utils.getFromStorage)("selectedSeats") || [];
        this.reservedSeats = (0, _utils.getFromStorage)("reservedSeats") || [];
        for(let row = 1; row <= this.size.rows; row++)for(let number = 1; number <= this.size.seatsInRow; number++){
            const newChair = new (0, _chairDefault.default)(row, number);
            if (this.selectedSeats.find((seat)=>seat.row === newChair.row && seat.number === newChair.number)) newChair.status = (0, _utils.STATUSES).CHOISE;
            else if (this.reservedSeats.find((seat)=>seat.row === newChair.row && seat.number === newChair.number)) newChair.status = (0, _utils.STATUSES).PICKED;
        ...
        if (e.target.closest(".cinema__seats__seat")) {
            ...
            if (eventObj.status == (0, _utils.STATUSES).FREE) {
                eventObj.changeStatus((0, _utils.STATUSES).CHOISE);
                this.selectedSeats.push(eventObj);
                (0, _utils.saveToStorage)("selectedSeats", this.selectedSeats);
                this.refreshResults();
            } else if (eventObj.status == (0, _utils.STATUSES).CHOISE) {
                eventObj.changeStatus((0, _utils.STATUSES).FREE);
                (0, _utils.deleteFromStorage)("selectedSeats");
    ...
    this.reserveSeats = ()=>{
        (0, _utils.saveToStorage)("reservedSeats", this.selectedSeats);
        this.selectedSeats.forEach((seat)=>seat.changeStatus((0, _utils.STATUSES).PICKED));
        this.selectedSeats = [];
        (0, _utils.deleteFromStorage)("selectedSeats");
    };
    this.rejectSeats = ()=>{
        setTimeout(()=>{
            this.selectedSeats = [];
            this.refreshResults();
            this.allSeats.forEach((seat)=>seat.changeStatus((0, _utils.STATUSES).FREE));
            (0, _utils.deleteFromStorage)("selectedSeats");
        }, 900000);
    };
}
...
},{"../utils":"5Zwrt","./chair":"3duW0","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5Zwrt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const SVG = `<svg width="50" height="46" viewBox="0 0 50 46" fill="none" xmlns="http://www.w3.org/2000/svg">
...
},{}],"3duW0":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _utilsJs = require("../utils.js");
function Chair(row, number, status = (0, _utilsJs.STATUSES).FREE) {
    this.row = row;
    this.number = number;
    this.status = status;
    this.elements = {
    ...
    this.render = (parent)=>{
        ...
        this.elements.self.insertAdjacentHTML("afterbegin", (0, _utilsJs.SVG));
...
},{"../utils.js":"5Zwrt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6OOFy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "timerToReject", ()=>timerToReject);
function timerToReject() {
    ...
    let endTime = startTime + 900000;
    let timerId = setInterval(()=>{
        let timeNow = Date.now();
        let timeToEnd = endTime - timeNow;
        if (timeToEnd > 0) {
            let minutes = Math.floor(timeToEnd % 3600000 / 60000);
            let seconds = Math.floor(timeToEnd % 60000 / 1000);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["lNSW0","jUTag"], "jUTag", "parcelRequire94c2")
